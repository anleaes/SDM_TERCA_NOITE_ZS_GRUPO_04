...
urlpatterns = [
    ...
    path('clientsocialnetwork/', include('clientsocialnetwork.urls', namespace='clientsocialnetwork')),
    ...
    path('api/orderitem/', include('apps.orderitem.urls', namespace='orderitem')),
